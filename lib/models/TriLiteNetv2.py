...
from lib.models.efficientFCN.encoding.models.efficientFCN import MHGDTwinLiteNet2ScaledTriLiteNet
...
def TriLiteNet(model_cfg):
    TriLiteNet = [
        ...
        [-1, Detect, [1, [[4, 12, 7, 19, 11, 28], [17, 40, 25, 58, 38, 89], [62, 136, 88, 206, 124, 412]],
                      [model_cfg['chanels'][3], model_cfg['chanels'][3], model_cfg['chanels'][3]]]],  # 2
        # [0, SegmentHead, [model_cfg]],  # 3
        [0, MHGDTwinLiteNet2ScaledTriLiteNet, [model_cfg]],  # 3
        # [3, UpSimpleBlock, [model_cfg['chanels'][0], 2]],  # 4
        # [3, UpSimpleBlock, [model_cfg['chanels'][0], 2]],  # 5
        [3, UpSimpleBlock, [32, 2]],  # 4
        [3, UpSimpleBlock, [32, 2]],  # 5
    ]
    return TriLiteNet
